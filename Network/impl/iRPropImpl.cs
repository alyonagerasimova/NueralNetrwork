...
namespace NueralNetrwork.Network.impl
{
    class iRPropImpl
    {
        ...
        public double[] getHiddenValuesPrev()
        {
            return hiddenValuesPrev;
        }

        private double[] hiddenValuesPrev; // значение скрытого нейрона

        public double[] getOutputValuesPrev()
        {
            return outputValuesPrev;
        }
        ...
        public iRPropImpl(int numberHiddenNeurons, double numberLearningRate) {
        this.numberHiddenNeurons = numberHiddenNeurons;
